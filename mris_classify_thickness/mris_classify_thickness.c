...
static char vcid[] = "$Id: mris_classify_thickness.c,v 1.8 2011/03/02 00:04:29 nicks Exp $";
...
main(int argc, char *argv[]) {
  ...
  *vbest_pvalues, current_min_label_area, current_fthresh ;
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_classify_thickness.c,v 1.8 2011/03/02 00:04:29 nicks Exp $", "$Name: release_5_3_0 $");
