...
int main(int argc, char **argv) {
  ...
  make_cmd_version_string (argc, argv,
                           "$Id: mri_label2vol.c,v 1.34.2.5 2012/06/08 17:31:03 greve Exp $", "$Name: release_5_3_0 $", cmdline);

  /* rkt: check for and handle version tag */
  nargs = handle_version_option (argc, argv,
                                 "$Id: mri_label2vol.c,v 1.34.2.5 2012/06/08 17:31:03 greve Exp $", "$Name: release_5_3_0 $");
