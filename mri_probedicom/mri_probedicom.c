...
static char vcid[] = "$Id: mri_probedicom.c,v 1.33.2.1 2011/04/06 18:18:11 greve Exp $";
char *Progname = NULL;
...
int main(int argc, char **argv) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: mri_probedicom.c,v 1.33.2.1 2011/04/06 18:18:11 greve Exp $", "$Name: stable5 $");
