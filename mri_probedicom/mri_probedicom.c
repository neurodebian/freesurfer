...
static char vcid[] = "$Id: mri_probedicom.c,v 1.33.2.2 2011/06/01 15:13:22 greve Exp $";
char *Progname = NULL;
...
int main(int argc, char **argv) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: mri_probedicom.c,v 1.33.2.2 2011/06/01 15:13:22 greve Exp $", "$Name: stable5 $");
