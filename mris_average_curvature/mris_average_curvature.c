...
static char vcid[] = "$Id: mris_average_curvature.c,v 1.17 2011/03/02 00:04:26 nicks Exp $";
...
main(int argc, char *argv[]) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_average_curvature.c,v 1.17 2011/03/02 00:04:26 nicks Exp $", "$Name: release_5_3_0 $");
