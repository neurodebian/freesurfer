...
static char vcid[] = "$Id: mris_label_mode.c,v 1.6 2011/03/02 00:04:32 nicks Exp $";
...
main(int argc, char *argv[]) {
  ...
  *hemi ;
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_label_mode.c,v 1.6 2011/03/02 00:04:32 nicks Exp $", "$Name: release_5_3_0 $");
