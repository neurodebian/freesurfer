...
main(int argc, char *argv[])
{
  ...
  make_cmd_version_string (argc, argv, "$Id: mri_edit_wm_with_aseg.c,v 1.23.2.1 2012/02/29 18:30:35 nicks Exp $", "$Name: release_5_3_0 $", cmdline);

  /* rkt: check for and handle version tag */
  nargs = handle_version_option (argc, argv, "$Id: mri_edit_wm_with_aseg.c,v 1.23.2.1 2012/02/29 18:30:35 nicks Exp $", "$Name: release_5_3_0 $");
