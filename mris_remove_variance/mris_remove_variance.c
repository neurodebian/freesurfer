...
static char vcid[] = "$Id: mris_remove_variance.c,v 1.7 2011/03/02 00:04:33 nicks Exp $";
...
main(int argc, char *argv[]) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_remove_variance.c,v 1.7 2011/03/02 00:04:33 nicks Exp $", "$Name: release_5_3_0 $");
