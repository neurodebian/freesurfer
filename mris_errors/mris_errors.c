...
static char vcid[]="$Id: mris_errors.c,v 1.11 2011/03/02 00:04:31 nicks Exp $";
...
main(int argc, char *argv[]) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_errors.c,v 1.11 2011/03/02 00:04:31 nicks Exp $", "$Name: release_5_3_0 $");
