...
static char vcid[] = "$Id: mri_surfcluster.c,v 1.51.2.1 2011/03/28 15:32:36 greve Exp $";
char *Progname = NULL;
...
int main(int argc, char **argv) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: mri_surfcluster.c,v 1.51.2.1 2011/03/28 15:32:36 greve Exp $", "$Name: release_5_1_0 $");
