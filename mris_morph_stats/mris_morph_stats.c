...
static char vcid[] = "$Id: mris_morph_stats.c,v 1.6 2011/03/02 00:04:33 nicks Exp $";
...
main(int argc, char *argv[]) {
  ...
  *morph_name, *out_name ;
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_morph_stats.c,v 1.6 2011/03/02 00:04:33 nicks Exp $", "$Name: release_5_3_0 $");
