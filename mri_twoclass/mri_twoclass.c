...
static char vcid[] = "$Id: mri_twoclass.c,v 1.15 2011/03/02 00:04:25 nicks Exp $";
...
main(int argc, char *argv[]) {
  ...
  **c1_subjects, **c2_subjects, *output_subject ;
  ...
  nargs = handle_version_option (argc, argv, "$Id: mri_twoclass.c,v 1.15 2011/03/02 00:04:25 nicks Exp $", "$Name: release_5_3_0 $");
