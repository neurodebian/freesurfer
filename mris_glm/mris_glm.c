/*
  ...
  $Id: mris_glm.c,v 1.35.2.1 2005/05/12 15:30:32 greve Exp $
...
static char vcid[] = "$Id: mris_glm.c,v 1.35.2.1 2005/05/12 15:30:32 greve Exp $";
char *Progname = NULL;
...
int main(int argc, char **argv)
{
  ...
  nargs = handle_version_option (argc, argv, 
      "$Id: mris_glm.c,v 1.35.2.1 2005/05/12 15:30:32 greve Exp $", "$Name:  $");
