...
main(int argc, char *argv[]) {
  ...
  make_cmd_version_string (argc, argv, "$Id: mri_threshold.c,v 1.7 2011/03/02 00:04:25 nicks Exp $", "$Name: release_5_3_0 $", cmdline);
  /* rkt: check for and handle version tag */
  Progname = argv[0] ;
  nargs = handle_version_option (argc, argv, "$Id: mri_threshold.c,v 1.7 2011/03/02 00:04:25 nicks Exp $", "$Name: release_5_3_0 $");
