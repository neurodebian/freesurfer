...
main(int argc, char *argv[])
{
  ...
  nargs = handle_version_option (argc, argv, "$Id: mri_ms_EM.c,v 1.11 2011/03/02 00:04:55 nicks Exp $", "$Name: stable5 $");
...
double NbhdLikelihood(MRI **mri_mem, MRI *mri_mask, int x, int y, int z, int label, int num_classes)
{
  ...
  for (index = 0; index < 6; index++)
  {
    ...
    { /* soft penalty, will tie more closely to a smoothing of probability itself*/
