...
static char vcid[] = "$Id: mris_segment_vals.c,v 1.5 2011/03/02 00:04:34 nicks Exp $";
...
main(int argc, char *argv[]) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_segment_vals.c,v 1.5 2011/03/02 00:04:34 nicks Exp $", "$Name: release_5_3_0 $");
