...
static char vcid[] = "$Id: mris_reverse.c,v 1.10 2011/03/02 00:04:33 nicks Exp $";
...
main(int argc, char *argv[]) {
  ...
  nargs = handle_version_option (argc, argv, "$Id: mris_reverse.c,v 1.10 2011/03/02 00:04:33 nicks Exp $", "$Name: release_5_3_0 $");
